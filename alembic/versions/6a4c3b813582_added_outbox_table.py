...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_outbox_unprocessed'), table_name='outbox_events')
...
def downgrade() -> None:
    ...
    op.create_index(op.f('ix_outbox_unprocessed'), 'outbox_events', ['processed_at', 'created_at'], unique=False)
    # ### end Alembic commands ###
